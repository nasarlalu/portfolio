                ...
                >
                    {isOpen && (
                        ...
                        >
                            ...
                            <Link className={styles.ui_btn} href="/chat">
                                <span className={styles.navlinktext}>Chat</span>
                            </Link>
                            {session ?
                                <div className={styles.ui_btn}>
                                    <span className={styles.navlinktext} onClick={() => signOut({ callbackUrl: "/chat" })}>Sign out</span>
                                </div> :
                                <div className={styles.ui_btn}>
                                    <span
                                        className={styles.navlinktext}
                                        onClick={() => signIn("google", { callbackUrl: `${window.location.origin}/chat` })}>
                                        Sign In
                                    </span>
                                </div>
                            }
