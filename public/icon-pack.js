...
export const ShopifyIcon = ({ className = "" }) => {
    return (
        <svg
            className={className}
            xmlns="http://www.w3.org/2000/svg"
...
export const ChatLoaderIcon = ({ className = "" }) => {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
            <radialGradient id="a12" cx=".66" fx=".66" cy=".3125" fy=".3125" gradientTransform="scale(1.5)">
                <stop offset="0" stopColor="#222222"></stop><stop offset=".3" stopColor="#222222" stopOpacity=".9"></stop>
                <stop offset=".6" stopColor="#222222" stopOpacity=".6"></stop>
                <stop offset=".8" stopColor="#222222" stopOpacity=".3"></stop>
                <stop offset="1" stopColor="#222222" stopOpacity="0"></stop>
            </radialGradient>
            ...
            <circle transformOrigin="center" fill="none" opacity=".2" stroke="#222222" strokeWidth="15" strokeLinecap="round" cx="100" cy="100" r="70"></circle>
        </svg>
    )
}